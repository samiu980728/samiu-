...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    vcRoot.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"账号" image:[UIImage imageNamed:@"32 2.png"] tag:0];
    
    VCSecond * vcSecond = [[VCSecond alloc]init];
    vcSecond.view.backgroundColor = [UIColor whiteColor];
    vcSecond.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"我的音乐" image:[UIImage imageNamed:@"33.png"] tag:1];
